...
def load_data(T=3, nb_flow=1, len_closeness=None, len_period=None, len_trend=None,
    ...
    #data_all = np.transpose(data_all, (0, 3, 2, 1))
    ...
    if metadata_dim is None or metadata_dim < 1:
        metadata_dim = None
