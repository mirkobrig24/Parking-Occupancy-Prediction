...
class STMatrix(object):
    ...
    def __init__(self, data, timestamps, T=3, CheckComplete=True, Hours0_23=False):
    ...
    def create_dataset(self, len_closeness=12, len_trend=0, TrendInterval=7, len_period=0, PeriodInterval=1):
        """current version
        """
