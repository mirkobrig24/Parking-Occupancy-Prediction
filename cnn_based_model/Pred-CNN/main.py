...
def train_model(lr, batch_size, num_hidden, encoder_length, decoder_length, save_results=False, i=''):
    ...
    # model.summary()
    hyperparams_name = 'Parking_{}_{}.c{}.p{}.t{}.num_hidden_{}.encoder_length_{}.decoder_length_{}.lr_{}.batchsize_{}'.format(
        task, i, len_c, len_p, len_t, num_hidden, encoder_length, decoder_length,
        lr, batch_size)
    ...
    if (save_results):
        ...
        # save to csv
        csv_name = os.path.join('results', f'pred-cnn_Parking_{task}_results.csv')
