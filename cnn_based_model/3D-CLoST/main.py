...
if os.path.exists(fname) and CACHEDATA:
    ...
    timestamp_train_all, timestamp_train, timestamp_val, timestamp_test, mask = read_cache(
        fname, 'preprocessing_parking.pkl')
...
def train_model(lr, batch_size, lstm, lstm_number, save_results=False, i=''):
    ...
    # model.summary()
    hyperparams_name = 'Parking_{}_{}.c{}.p{}.t{}.lstm_{}.lstmnumber_{}.lr_{}.batchsize_{}'.format(
            task, i, len_c, len_p, len_t, lstm, lstm_number, lr, batch_size)
    ...
    if (save_results):
        ...
        # save to csv
        csv_name = os.path.join('results', f'3dclost_Parking_{task}_results.csv')
