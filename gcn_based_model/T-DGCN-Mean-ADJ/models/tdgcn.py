...
from utils.graph_conv import get_Sign_Magnetic_Laplacian
...
class TDGCNGraphConvolution(nn.Module):
    ...
    def propagate(self, mul_L_real, mul_L_imag, X_real, X_imag, weight, num_nodes, features, batch_size):
    ...
    def forward(self, inputs, hidden_state):
        ...
        self.weights, num_nodes, features, batch_size)
